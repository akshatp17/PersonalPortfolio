    ...
    return (
        ...
        >
            <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => navigate(-1)}
                className="bg-sky-300 text-black font-bold px-4 py-2 rounded-full hover:bg-sky-600 transition duration-250 hover:cursor-pointer absolute"
            >
                ← Back
            </motion.button>
                        ...
                        <div className="flex gap-5 w-full justify-center">
                            {project.projectLink && (
                                <motion.a
                                    ...
                                    className="flex items-center gap-2 px-4 py-2 border border-sky-300 rounded-full text-sky-300 hover:bg-sky-300 hover:text-black transition duration-300"
                                >
                                    <CodeXml size={18} />
